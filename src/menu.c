...
/* brand accent color: was blue (COLOR_LIGHT_BLUE / COLOR_BLUE), now orange to match FF9900 brand */
#define MENU_BAR_COLOR COLOR_ORANGE
...
)
{
    ...
    {
#ifdef CONFIG_SLIM_MENUS
        /* Dual ISO / White Balance: dial only, no submenu. */
