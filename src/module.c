...
static void module_load_task(void* unused)
{
    ...
    if(!module_autoload_disabled)
    {
        ...
        else
        {
            ...
            snprintf(config_file, sizeof(config_file), "ML/FIRST", get_config_dir());
            ...
            if(!first_run)
            {
                ...
                snprintf(preset_dir1, sizeof(preset_dir1), "ML/SETTINGS/CM1", get_config_dir());
                snprintf(preset_dir2, sizeof(preset_dir2), "ML/SETTINGS/CM2", get_config_dir());
                snprintf(preset_dir3, sizeof(preset_dir3), "ML/SETTINGS/CM3", get_config_dir());
                snprintf(preset_dir4, sizeof(preset_dir4), "ML/SETTINGS/CM4", get_config_dir());
                snprintf(preset_dir5, sizeof(preset_dir5), "ML/SETTINGS/CM5", get_config_dir());
